...
//           .updateUserDetails(displayName: testName);
//       await tester.pumpAndSettle();
//
//       // Assert
...
//       await container
//           .read(userProvider.notifier)
//           .updateUserDetails(displayName: 'First Name');
//       await tester.pumpAndSettle();
//
...
//       await container
//           .read(userProvider.notifier)
//           .updateUserDetails(displayName: 'Second Name');
//       await tester.pumpAndSettle();
//
//       // Assert
...
//         await container
//             .read(userProvider.notifier)
//             .updateUserDetails(displayName: 'User $i');
//       }
//       await tester.pumpAndSettle();
//
